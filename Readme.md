...
* [x] Show last 3 comments for each photo
* [x] Allow user to view all comments for an image within a separate activity or dialog fragment
* [x] Allow video posts to be played in full-screen using the VideoView

The following **additional** features are implemented:

* [x] Added an animated like button!
* [x] Clicking on the username, callout, location or a hashtag displays a new page with recent media for the selected option
* [x] Overflow menu displayed when clicked on the 'Settings' icon for each item lets the user copy the share URL for the image to clipboard
* [x] Maintains a backstack so user can browse back to the previous page
